...
public class AADS_Pictures_04 {
	static WebDriver webDriver, webDriver2;
	AADSWebKeywords AADSWebDriver = new AADSWebKeywords();
	Selenium selenium = new Selenium();
	DriverManagement driverMgnt = new DriverManagement();
	aadsData aadsData = new aadsData();
	final static Logger logger = LogManager.getLogger("AADS_Pictures_004");

	
	@Before
	public void beforetestAADS_Pictures_04() throws Exception {
		logger.info("beforetest AADS_Pictures_004 starting...\n");
		webDriver = driverMgnt.createChromeDriver();
		webDriver2 = driverMgnt.createChromeDriver();
		logger.info("beforetest AADS_Pictures_004 completed...\n");
	}
	
	@Test 
	public void testAADS_Pictures_04 () throws Exception {
		logger.info("AADS_Pictures_04 - starting...\n");
		...
		//verify Portal setting page upload image not existed
		boolean s = AADSWebDriver.verifyPortalSettingsPageUploadImgExisted(webDriver2);
		assertTrue(s);
		
		logger.info("AADS_Pictures_04 - completed...\n");
	}
