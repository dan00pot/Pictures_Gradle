...
public class AADS_Pictures_03 {
	static WebDriver webDriver, webDriver2;
	AADSWebKeywords AADSWebDriver = new AADSWebKeywords();
	Selenium selenium = new Selenium();
	DriverManagement driverMgnt = new DriverManagement();
	aadsData aadsData = new aadsData();
	final static Logger logger = LogManager.getLogger("AADS_Pictures_003");
	

	@Before
	public void beforetestAADS_Pictures_03() throws Exception {
		logger.info("beforetest AADS_Pictures_003 starting...\n");
		webDriver = driverMgnt.createFFDriver();
		webDriver2 = driverMgnt.createFFDriver();
		logger.info("beforetest AADS_Pictures_003 completed...\n");
	}
	
	@Test 
	public void testAADS_Pictures_03 () throws Exception {
		logger.info("AADS_Pictures_03 - starting...\n");
		...
		boolean s = AADSWebDriver.esgPortalSettingsPageDeleteImg(webDriver2);	
		assertTrue(s);
		
		logger.info("AADS_Pictures_03 - completed...\n");
	}
